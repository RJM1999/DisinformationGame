...
class LevelClass
{
    ...
    func makeAsset()
    {
        ...
        let tvCamp = Asset(name:"TV Campaign", Desc: "Party political broadcasts enough to make you change the channel",cost: 50,bonus:  10)
        let flyers = Asset(name:"Flyer campaign", Desc: "Post flyers to voters, cheap but often thrown in the bin",cost: 10,bonus:  10)
